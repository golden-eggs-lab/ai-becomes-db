...
parser.add_argument('--use_ann', dest='use_ann', action='store_true', default=False, help='use ANN acceleration for greedy selection')
parser.add_argument('--ann_k', type=int, default=20, help='number of ANN candidates (default: 20)')
parser.add_argument('--ann_backend', type=str, default='nearpy', choices=['nearpy', 'milvus', 'spark'], help='ANN backend: nearpy, milvus, or spark (default: nearpy)')
            ...
            if subset_size >= 1 or epoch < args.start_subset:
                ...
                if greedy == 0:
                    ...
                    subset, subset_weight, _, _, ordering_time, similarity_time = util.get_orders_and_weights(
                        ...
                        equal_num=True, use_ann=args.use_ann, ann_k=args.ann_k, ann_backend=args.ann_backend)
